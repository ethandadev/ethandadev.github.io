...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const animateElements = document.querySelectorAll('.course-card, .feature-card, .stat-item');
    ...
    enrollButtons.forEach(btn => {
        btn.addEventListener('click', (e) => {
            ...
            const courseName = courseCard.querySelector('.course-title')?.textContent || '未知课程';
            const coursePrice = courseCard.querySelector('.course-price')?.textContent || '¥0';
    ...
    function showEnrollModal(courseName, price) {
                ...
                <div class="modal-body">
                    <form id="enrollForm">
                        <div class="form-group">
                            <label>姓名</label>
                            <input type="text" id="enrollName" placeholder="请输入您的姓名" required>
                        </div>
                        <div class="form-group">
                            <label>手机号</label>
                            <input type="tel" id="enrollPhone" placeholder="请输入您的手机号" required>
                        </div>
                        <div class="form-group">
                            <label>邮箱</label>
                            <input type="email" id="enrollEmail" placeholder="请输入您的邮箱" required>
                        </div>
                        <div class="form-group">
                            <label>学习基础</label>
                            <select id="enrollLevel">
                                <option value="">请选择您的编程基础</option>
                                <option value="zero">零基础</option>
                                <option value="beginner">有一定基础</option>
                                <option value="intermediate">中级水平</option>
                                <option value="advanced">高级水平</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <p class="enroll-price">课程费用：<strong>${price}</strong></p>
                        </div>
                        <button type="submit" class="btn btn-submit">确认报名</button>
                    </form>
                    <div class="modal-success" style="display:none;">
                        <div class="success-icon">✅</div>
                        <h3>报名成功！</h3>
                        <p>恭喜您成功报名 <strong>${courseName}</strong></p>
                        <p>我们将在24小时内通过邮件发送课程详情</p>
        ...
        enrollForm.addEventListener('submit', (e) => {
            ...
            showToast('报名成功！欢迎加入编程学院', 'success');
        });
    }
